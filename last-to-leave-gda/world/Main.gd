...
func _ready() -> void:
	...
	inv_interface.set_weapon_inventory_data(test_player.weapon_inventory_data)
...
func _physics_process(delta):
	get_tree().call_group("enemies", "update_target_location", test_player.global_transform.origin)
